...
const en: Record<string, string> = {
  ...
  'settings.mcp_server_desc': 'Exposes read-only tools (terminal output, git status, agent list, repo list) to MCP clients (Claude Code, Claude Desktop) on the same network (Wi-Fi/VPN). Requires the bearer token below in the client\'s MCP config. No exec/write tools yet. Default off.',
