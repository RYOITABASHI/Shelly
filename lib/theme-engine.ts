...
export const BUILTIN_THEMES: Theme[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      surfaceAlt: '#D9D0B0',
      foreground: '#201D16',
      // 2026-09-16: darkened muted/inactive/warning/green from the mockup's
      // original tones — they read fine as a static preview but fell under
      // WCAG AA against the cream backgrounds once used for real small
      // text (see lib/theme-presets.ts's caseFilePalette, same fix).
      muted: '#4A4636',
      accent: '#2A2416',
      border: '#2A2416',
      success: '#2E4A2E',
