...
// agentNeedsDeviceStatusContext) — these tests are about the MERGE logic
// specifically (multiple *.json files → one flat object), not the gate
// itself (covered separately below), so the wrapper force-sets the flag on.
