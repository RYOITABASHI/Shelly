...
| Shelly companion presentation — AI Pane replies use “Shelly” as the default speaker instead of the raw provider name; an explicitly `@`-routed provider remains visible as a secondary tag, with conversational registration / confirmation copy | 🟡 implemented and tsc/Jest-verified; on-device verification has **not** happened yet and is scheduled for tomorrow (2026-08-15) |
