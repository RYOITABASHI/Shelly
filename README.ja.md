...
<p align="center">
  <img src="docs/images/companion-memory.jpg" alt="Shellyのコンパニオンメモリ画面 — コンパニオンが自分でつけたセッションの要約と、あなたが覚えておいてと頼んだノートの両方を、閲覧・編集・削除できる" width="500">
</p>

Shellyは自分専用の日誌をつけています。会話が終わると自分自身のために要約を書き残し、あなたが覚えておいてと頼んだことはコンパニオン自身とすべてのバックグラウンドエージェントに想起されます——その全てを**Settings → Companion Memory**から閲覧・編集・削除できます。登録済みのエージェントが1つも無い段階でも到達可能です。
