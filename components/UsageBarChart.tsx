...
const styles = StyleSheet.create({
  ...
  dayLabel: { fontSize: 9, color: '#666', fontFamily: 'JetBrainsMono_400Regular', textAlign: 'center', flex: 1 },
  ...
  footerText: { fontSize: 9, color: '#888', fontFamily: 'JetBrainsMono_400Regular' },
});
