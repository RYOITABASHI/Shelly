...
export const MarkdownRenderer = memo(function MarkdownRenderer({ content }: Props) {
  ...
  const codeBg = usePanelBackground('#0D0D0D');
  const mdStyles = {
    ...
    code_inline: { backgroundColor: withAlpha(colors.foreground, 0.08), color: colors.accent, fontFamily: 'JetBrainsMono_400Regular', fontSize: 13 },
    code_block: { backgroundColor: codeBg, color: '#E8E8E8', fontFamily: 'JetBrainsMono_400Regular', fontSize: 12, padding: 10, borderRadius: 6 },
    fence: { backgroundColor: codeBg, color: '#E8E8E8', fontFamily: 'JetBrainsMono_400Regular', fontSize: 12, padding: 10, borderRadius: 6 },
