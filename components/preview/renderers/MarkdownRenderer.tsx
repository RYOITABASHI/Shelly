...
export const MarkdownRenderer = memo(function MarkdownRenderer({ content }: Props) {
  ...
  const mdStyles = {
    ...
    code_block: { backgroundColor: '#0D0D0D', color: '#E8E8E8', fontFamily: 'JetBrainsMono_400Regular', fontSize: 12, padding: 10, borderRadius: 6 },
    fence: { backgroundColor: '#0D0D0D', color: '#E8E8E8', fontFamily: 'JetBrainsMono_400Regular', fontSize: 12, padding: 10, borderRadius: 6 },
