...
const styles = StyleSheet.create({
  ...
  text: { fontFamily: 'JetBrainsMono_400Regular', fontSize: 16, fontWeight: '600' },
  subtext: { fontFamily: 'JetBrainsMono_400Regular', fontSize: 12 },
  button: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  buttonText: { fontFamily: 'JetBrainsMono_400Regular', fontSize: 13, fontWeight: '600' },
});
